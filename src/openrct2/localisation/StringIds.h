...
enum : uint16_t
{
    ...
    STR_SORT_ARROW_UP = 6462,
    STR_SORT_ARROW_DOWN = 6463,
    STR_SORT_NAME = 6464,
    STR_SORT_COST = 6465,
    STR_SORT_EXCITEMENT = 6466,
    STR_SORT_INTENSITY = 6467,
    STR_SORT_NAUSEA = 6468,
    STR_SORT_MAX_SPEED = 6469,
    STR_SORT_AVERAGE_SPEED = 6470,
    STR_SORT_RIDE_LENGTH = 6471,
    STR_SORT_MAX_POSITIVE_VERTICAL_G = 6472,
    STR_SORT_MAX_NEGATIVE_VERTICAL_G = 6473,
    STR_SORT_MAX_LATERAL_G = 6474,
    STR_SORT_DROPS = 6475,
    STR_SORT_HIGHEST_DROP_HEIGHT = 6476,
    STR_SORT_SPACE_REQUIRED = 6477,
    STR_SORT_HOLES = 6478,
    STR_SORT_TOTAL_AIR_TIME = 6479,
